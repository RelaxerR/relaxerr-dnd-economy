...
- Деплой (2026-08-09): сервер 77.110.104.211, Ubuntu 24.04, на нём уже крутятся 4 других
  ...
  "прогнать миграции" в пайплайне деплоя нет.
...
| 4 | Rate limiting под нагрузкой, деплой, полировка стиля | Деплой готов (Docker + автодеплой из git), полировка стиля — не начата |
